...
const EditeMenuModalArchived = ({ closeModal,id,reloadActive }: any) => {
    ...
    const formik = useFormik({
        initialValues: {ppImgBase64: "",fname: "",lname: "",peopleGroup: "",email: "",phoneNumber: "506564794",address: "",city: "",country: "", isArchived:true},
    ...
    return (
        <AnimatePresence mode="wait">
            {open ?
                <motion.form
                    className="form fomr_contact arc"
                    key={"modal98000000"}
...
export default EditeMenuModalArchived;