...
const RoleEditMenu = ({ closeModal2,id,reloadActive }: any) => {
            ...
            {open ?
                <motion.form
                    ...
                    <div className="btn-grp">
                        ...
                        }}>{t("Contacts.modal2.b3")}</Button> {/* Ensure type="submit" */}
                    </div>
                </motion.form>
                : null}
        </AnimatePresence>
